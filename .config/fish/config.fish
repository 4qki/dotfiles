...
set -U fish_user_paths $HOME/.bin $HOME/.local/bin $HOME/.local/bin/statusbar $HOME/.cargo/bin $HOME/.config/emacs/bin $HOME/Applications /var/lib/flatpak/exports/bin/ $fish_user_paths

### EXPORT ###
set fish_greeting # Supresses fish's intro message
set TERM xterm-256color # Sets the terminal type
set TERMINAL ghostty # Set terminal
...
# change rm to trash to prevent accidental deletions
alias rm='trash'
...
alias orphan='doas pacman -Rns (pacman -Qtdq)' # remove orphaned packages (DANGEROUS!)
